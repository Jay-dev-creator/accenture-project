// Data for services offered, used in Services.js

const data = [
    {
        id: 1,
        icon: require("./assets/images/Web Dev Icon.png"),
    ...
    {
        id: 1,
        icon: require("./assets/images/UX Icon.png"),
    ...
    {
        id: 1,
        icon: require("./assets/images/App Dev Icon.png"),
    ...
    {
        id: 1,
        icon: require("./assets/images/BlockchainIcon.png"),
